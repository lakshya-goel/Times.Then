...
fun NewsNavigator() {
    ...
    val bottomNavigationItems = remember {
        listOf(
            ...
            BottomNavigationItem(icon = R.drawable.baseline_bookmarks_24, text = "Saved"),
        )
    }
    ...
    //Hide the bottom nav in detail screen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(route = Route.DetailsScreen.route) {
                ...
                //Gives Toast message :: SAVED/DELETED
                ...
                //backstack entry imp, if in detail screen how we get back so
